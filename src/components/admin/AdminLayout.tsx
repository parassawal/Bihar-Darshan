    ...
    <div className="min-h-screen bg-[#0a0a0f] flex">
      ...
      `}>
        ...
        <div className="flex items-center justify-between px-4 h-16 border-b border-white/[0.06] shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#D4A017] to-[#a67c00] flex items-center justify-center shrink-0">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 border-b border-white/[0.06] bg-[#0a0a0f]/80 backdrop-blur-xl flex items-center justify-between px-6 shrink-0 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-3">
            <Link to="/" className="text-xs text-white/30 hover:text-[#D4A017] transition-colors border border-white/10 px-3 py-1.5 rounded-lg hover:border-[#D4A017]/30">
              View Site →
            </Link>
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#D4A017] to-[#a67c00] flex items-center justify-center text-black text-xs font-bold">
              A
            </div>
          </div>
        </header>
